...
# fact_P_values_1 = fact_P_values_K[1::]
# Em_values_1 = Em_values[1::]

# fact_P_values_1 = fact_P_values_NHE[1::]
# Em_values_1_NHE = Em_values_NHE[1::]
...
# valu of Em for fact_p = 1 (tolerence : 1e-2)
# POS_fact_P_1 = np.where(np.isclose(fact_P_values, 1.0, atol=1e-2))[0]
